async function createOOEF() {
  ...
  let ooefData = {
    values: [ // note some field names are left commented out because you don't need them for events w/ +10 people. just keeping them around in case someone does need them later
